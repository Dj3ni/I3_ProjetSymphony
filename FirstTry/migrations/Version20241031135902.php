 ...
 */
final class Version20241031135902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_occurrence_subscription (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, event_occurrence_id INT NOT NULL, subscription_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', occurrence_dates JSON NOT NULL COMMENT \'(DC2Type:json)\', number_participants INT DEFAULT NULL, INDEX IDX_FD585EE9A76ED395 (user_id), INDEX IDX_FD585EE9140E9F00 (event_occurrence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
