 ...
 */
final class Version20241018140131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_occurrence (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, number_participants INT NOT NULL, INDEX IDX_E61358DC71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_occurrence_event_subscription (event_occurrence_id INT NOT NULL, event_subscription_id INT NOT NULL, INDEX IDX_3B187FE1140E9F00 (event_occurrence_id), INDEX IDX_3B187FE153CBE3EC (event_subscription_id), PRIMARY KEY(event_occurrence_id, event_subscription_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event_subscription (id INT AUTO_INCREMENT NOT NULL, user_subscriptor_id INT DEFAULT NULL, subscription_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', number_participants INT NOT NULL, INDEX IDX_4ED56E203CECDD17 (user_subscriptor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event_occurrence_event_subscription ADD CONSTRAINT FK_3B187FE1140E9F00 FOREIGN KEY (event_occurrence_id) REFERENCES event_occurrence (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE event_occurrence_event_subscription ADD CONSTRAINT FK_3B187FE153CBE3EC FOREIGN KEY (event_subscription_id) REFERENCES event_subscription (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event_occurrence_event_subscription DROP FOREIGN KEY FK_3B187FE1140E9F00');
        $this->addSql('ALTER TABLE event_occurrence_event_subscription DROP FOREIGN KEY FK_3B187FE153CBE3EC');
        ...
        $this->addSql('DROP TABLE event_occurrence_event_subscription');
